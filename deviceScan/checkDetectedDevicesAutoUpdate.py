...
# main
def main():
        print("started checkDetectedDevicesAutoUpdate.py running")
    # arg1 = device file
    # arg2 = users file
    # arg3 = html file
    # arg4 = hostname file
    ...
    #     hostnameFile = sys.argv[4]
        deviceFile = os.path.join(Path(__file__).resolve().parent, "DeviceList.txt")
        usersFile = os.path.join(Path(__file__).resolve().parent, "knownDevicesAutoUpdate.html")
        htmlFile = os.path.join(Path(__file__).resolve().parent, "knownUsers.txt")
        hostnameFile = os.path.join(Path(__file__).resolve().parent, "HostNameList.txt")
